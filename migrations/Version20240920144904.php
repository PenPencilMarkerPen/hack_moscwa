 ...
 */
final class Version20240920144904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inform (id INT NOT NULL, admin_id INT NOT NULL, alpha VARCHAR(255) NOT NULL, betta VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
